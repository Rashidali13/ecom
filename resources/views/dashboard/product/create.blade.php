...
@section('content')
    ...
    <div class="row">
        ...
        <form class="form form-horizontal mar-top col-lg-12" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
            @csrf
                        ...
                        <div class="tab-content">
                            <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea rows="4" class="form-control" name="Dis" placeholder="Type General Description" data-role="tagsinput"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div id="demo-stk-lft-tab-6" class="tab-pane fade">
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('Qty')}}" name="Qty" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 2')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('Qty')}}" name="Qty2" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 3')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('Qty')}}" name="Qty3" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 4')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('Qty')}}" name="Qty4" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 5')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('Qty')}}" name="Qty5" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 6 ')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('Qty')}}" name="Qty6" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 1 price')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('price')}}" name="price" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 2 price')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('price')}}" name="price2" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 3 price')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('price')}}" name="price3" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 4 price')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('price')}}" name="price4" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 5 price')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('price')}}" name="price5" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label">{{__('Qty 6 price')}}</label>
                                    <div class="col-lg-7">
                                        <input type="number" min="0" step="0.01" placeholder="{{__('price')}}" name="price6" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group">
